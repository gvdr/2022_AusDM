...
# ╔═╡ 26dae7d4-7114-11ed-2b1e-5f81b050ac06
using OrdinaryDiffEq, Plots

# ╔═╡ bf16ec3e-a742-4b57-9b4b-34a988f779cc
using DifferentialEquations

# ╔═╡ 02329180-f3d8-4a74-bfb1-319d62f07610
md"""
# Dynamical Systems
...
# ╔═╡ b320a924-77f3-44a4-a7f9-5aafe469a168
a, b = [1.0, .5];
...
# ╔═╡ f1cc30a1-b967-494a-8986-8bee23b33286
begin
	p = [a, b]
	u₀ = [🐱₀,😄₀]
end

# ╔═╡ 1a826ec4-9147-4236-9156-2aef9d680bc2
...
# ╔═╡ e66ae8ed-34e3-4f7a-89cc-8684249a6051
solution = solve(prob,Tsit5(), saveat = 0.1)

# ╔═╡ b426f37c-7b33-49e2-973f-ce02f2ef1c9b
trajectories = Array(solution)'

# ╔═╡ 8656b7df-1059-4bf3-b360-6e2838b8b83b
plot( solution.t, trajectories, label = ["🐱" "😄"])

# ╔═╡ a4b628cf-e626-47e0-8bf4-1b362303aa08
plot(solution,idxs=(1,2))

# ╔═╡ 816e0145-81d0-42f7-a2fc-1a2fb8b7ba6e
md"""
...
# ╔═╡ c51e6f8d-4191-45d8-bf84-c30b0d7b8cd5
...
# ╔═╡ 4bdf8738-ba47-4d59-b2b3-d45112df9a5d
function σ_cat_love(du,u,p,t)
  du[1] = 0.4
  du[2] = 0.4
end

# ╔═╡ 313ae216-b5eb-4419-90d5-dc6b5ac2da81
...
# ╔═╡ e3086361-9f13-42da-8c22-7d0c5f869564
sde_sol = solve(prob_sde_cat_lover)

# ╔═╡ 4dd7fd14-5f60-47eb-9231-9683a9eb845e
plot(sde_sol.t, Array(sde_sol)')

# ╔═╡ e7d2f588-c37a-4e57-9a0a-dcceedcde528
plot(sde_sol,idxs=(1,2))

# ╔═╡ c3651b69-4a55-4f58-9e11-ffd257452cda
ensembleprob = EnsembleProblem(prob_sde_cat_lover)

# ╔═╡ 6a1b9361-5a55-477d-850a-7eb52d690e0f
sols = solve(ensembleprob,EnsembleThreads(),trajectories=100)

# ╔═╡ df410fd3-4e0b-44ee-b777-11703f4cca41
begin
...
julia_version = "1.8.3"
manifest_format = "2.0"
project_hash = "59b8eb99fe292f32f12501957b39b481ceeeba3e"
...
git-tree-sha1 = "009d14f6a8c09f8470a750a5f2cbb0ee8cef269a"
